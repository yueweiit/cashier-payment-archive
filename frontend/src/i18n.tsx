...
const zhToEs: Record<string, string> = {
  ...
  "导出数据": "Exportar datos",
  "导出每日应付": "Exportar pagos diarios",
  "开始日期": "Fecha inicial",
  "结束日期": "Fecha final",
  "导出 Excel": "Exportar Excel",
  "生成中": "Generando",
  "默认最近 30 天，最多选择六个自然月": "De forma predeterminada se seleccionan los últimos 30 días; el máximo es de seis meses naturales",
  "请选择开始和结束日期": "Seleccione las fechas de inicio y fin",
  "开始日期不得晚于结束日期": "La fecha inicial no puede ser posterior a la fecha final",
  "结束日期不得晚于今天": "La fecha final no puede ser posterior a hoy",
  "日期区间最多为六个自然月": "El intervalo máximo es de seis meses naturales",
  "明细超过单次导出容量上限，请缩短日期区间": "El detalle supera el límite de una exportación; reduzca el intervalo",
  "当前导出任务较多，请稍后重试": "Hay varias exportaciones en curso; inténtelo de nuevo más tarde",
  "历史数据包含无效日期，请联系管理员处理": "Los datos históricos contienen una fecha no válida; contacte al administrador",
  "导出失败，请稍后重试": "No se pudo exportar. Inténtelo de nuevo más tarde",
  ...
  "导入目标 Sheet": "Sheet de destino",
  "保留 Excel 原 Sheet": "Conservar las Sheets del Excel",
  "按所选币种填写原币金额；保存时自动采用当天汇率折算人民币，原币金额保持不变。": "Capture el importe en la moneda seleccionada; al guardar se calcula el equivalente en CNY con el tipo de cambio del día, sin cambiar el importe original.",
