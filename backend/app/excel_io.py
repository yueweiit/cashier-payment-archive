...
KNOWN_HEADER_ALIASES = {
    ...
    "payment_account": ["付款账户", "付款账号类型", "账户性质"],
    "expected_payment_account": ["预计支付账户", "计划支付账户", "Cuenta de pago prevista"],
    "expense_type": ["费用性质", "费用类型", "款项类型", "支出性质", "支出类别"],
    ...
    "payee_name": ["账户名", "收款人", "收款方", "供应商名称", "户名", "收款人名称"],
    "bank_name": ["开户行", "收款银行", "银行名称", "收款行（具体到分行）"],
    "invoice_status": ["开票情况", "发票情况", "票据情况", "是否开具发票"],
...
def row_from_sheet(
    ...
    row: Dict[str, Any] = {
        ...
        "dingding_id": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["dingding_id"])),
        "applicant": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["applicant"])),
        "payment_account": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["payment_account"])),
        "expected_payment_account": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["expected_payment_account"])),
        "expense_type": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["expense_type"])),
        "summary": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["summary"])),
        "style_name": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["style_name"])),
        "amount": amount_number(first_value(values_by_header, KNOWN_HEADER_ALIASES["amount"])),
        "paid_amount": amount_number(first_value(values_by_header, KNOWN_HEADER_ALIASES["paid_amount"])),
        "pending_amount": amount_number(first_value(values_by_header, KNOWN_HEADER_ALIASES["pending_amount"])),
        "currency": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["currency"])),
        "base_amount_cny": amount_number(first_value(values_by_header, KNOWN_HEADER_ALIASES["base_amount_cny"])),
        "fx_rate_cny_per_unit": amount_number(first_value(values_by_header, KNOWN_HEADER_ALIASES["fx_rate_cny_per_unit"])),
        "fx_rate_date": date_string(first_value(values_by_header, KNOWN_HEADER_ALIASES["fx_rate_date"])),
        "fx_rate_actual_date": date_string(first_value(values_by_header, KNOWN_HEADER_ALIASES["fx_rate_actual_date"])),
        "project": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["project"])),
        "bu": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["bu"])),
        "payee_account": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["payee_account"])),
        "payee_name": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["payee_name"])),
        "bank_name": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["bank_name"])),
        "invoice_status": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["invoice_status"])),
        "needed_payment_date": date_string(first_value(values_by_header, KNOWN_HEADER_ALIASES["needed_payment_date"])),
        "owner_confirmation": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["owner_confirmation"])),
        "finance_review": finance_review,
        "finance_manager_approval": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["finance_manager_approval"])),
        ...
        "overdue_status": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["overdue_status"])),
        "payer": stringify(first_value(values_by_header, KNOWN_HEADER_ALIASES["payer"])),
